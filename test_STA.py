...
class Buliding_Model():
    def model(self, Tx, Ty, n_a, n_s, learn_rate=0.1):
        ...
        opt = Adam(lr=learn_rate, beta_1=0.9, beta_2=0.999, decay=0.01)
...
###
df = pd.read_csv(r'/home/hbut/PycharmProjects/untitled/new_selected_data.csv', header=None)
